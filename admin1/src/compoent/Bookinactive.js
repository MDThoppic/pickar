...
export default function Bookinactive() {
  ...
  return (
    <div>
      <Booking />
      <div>
        <h5 className=' d-flex mt-3 justify-content-center uppercase'>In Active Booking</h5>
      ...
      <div className='d-flex justify-content-between me-5'>
        ...
        <Button variant="outline-success" size='lg'>
          <Link className='text-decoration-none text-dark ' to="/Bookactive" variant="outline-primary">Active book
          </Link>
        </Button>
        </div>
      </div>
