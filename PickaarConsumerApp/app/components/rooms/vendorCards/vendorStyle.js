...
export const vCardStyles = {
    ...
    C2: {
        ...
        container: { height: 150, width: '100%', flexDirection: 'column' },
        blockA: { height: 105, padding: 20 },
        blockB: { height: 45, paddingLeft: 20 },
        blockAContainer: { height: 50, flexDirection: 'column', justifyContent: 'space-around', alignItems: 'flex-start' },
        blockAContainerSubBlockA: { height: 30, width: '100%' , overflow: 'hidden', flexDirection: 'column', alignItems: 'flex-start' },
    ...
    common: {
        ...
        expValue: { fontSize: 10, fontFamily: fonts.RubikMedium, color: themeColors.primary, paddingLeft: 5,paddingRight:10, opacity: 0.9 },
        ...
        nameLabelTxt: { fontSize: 12, fontFamily: fonts.RubikMedium, color: themeColors.primary },
