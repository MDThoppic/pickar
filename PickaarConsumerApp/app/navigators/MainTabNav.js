...
const TabArr = [
    { route: 'home', label: 'Home', type: PIcons.Feather, activeIcon: 'home', inActiveIcon: 'home', component: Dashboard },
...
const TabButton = (props) => {
    ...
    useEffect(() => {
        if (focused) {
            ...
            viewRef.current.animate({ 0: { scale: .4, rotate: '0deg' }, 1: { scale: 1.4, rotate: '360deg' } });
        } else {
